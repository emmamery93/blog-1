...
! function(e) {
    ...
    function(e) {
        var t = function(t, n, o) {
            ...
            function f() {
                a.addEventListener && a.removeEventListener("load", f), a.media = o || "all"
            }
            return a.addEventListener && a.addEventListener("load", f), a.onloadcssdefined = c, c(f), a
        };
